...
public class Weather implements Serializable{
    ...
    @SerializedName("daily_forecast") public List<DailyForecastEntity> dailyForecast=new ArrayList<>();
    /**
    ...
    @SerializedName("hourly_forecast") public List<HourlyForecastEntity> hourlyForecast=new ArrayList<>();
